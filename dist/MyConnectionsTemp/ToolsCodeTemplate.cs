...
public class ToolsCodeTemplate:CodeTemplate
{
    public string GetCsharpType(ColumnSchema column)
	{
		...
		switch (column.DataType)
		{
            ...
            //由于MySql的bit类型为这个所以要做此修改
            //case DbType.UInt16: type= "ushort";break;
			case DbType.UInt16: type= "bool";break;
        ...
        //datetime默认可空类型
//        if(column.DataType==DbType.DateTime || column.DataType==DbType.Date || column.DataType==DbType.DateTime2)
//        {
//            type=type+"?";
//        }
//        
